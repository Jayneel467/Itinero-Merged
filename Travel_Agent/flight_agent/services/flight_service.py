...
class FlightService:
    ...
    async def cancel_booking(self, booking_id: str) -> dict[str, Any]:
        ...
        return {
            ...
            "contact": after.get("contact") or before.get("contact") or {},
            "passengers": after.get("passengers") or before.get("passengers") or [],
            "airline": after.get("airline") or before.get("airline"),
