...
export const SEO_META = {
  ...
  EXPLORE: {
    title: "Explore destinations - Itinero",
    description:
      "Hiking, biking, beaches, and more. Discover destinations with live fares on Itinero Explore.",
    keywords: "explore, hiking, biking, beach, trekking, travel destinations",
  },
  GO_CAMPAIGN: {
    title: "Itinero trip ideas",
    description: "Campaign landing — discover trips matched to your vibe.",
  },
  PACKAGES: {
    title: "Travel packages - Itinero",
    description: "Ready trips with stays and flights — hiking, beaches, cities, and more.",
    keywords: "packages, hiking packages, beach holidays, ready trips",
  },
  BOOKING: {
