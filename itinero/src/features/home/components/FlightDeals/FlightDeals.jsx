...
/** Popular routes — buttons open live LiteAPI search (no sample fares). */
const deals = [
  {
    id: 1,
    badge: "Popular",
      ...
      <ScrollReveal delay={0.1}>
        ...
        <div className="flex flex-col shrink-0 items-start gap-1 md:gap-[7px] mb-4 md:mb-0">
          ...
          <span className="text-[#F97211] text-[16px] md:text-xl lg:text-[18px] 2xl:text-2xl font-medium">
            Popular routes — tap to search live LiteAPI fares
          </span>
        </div>
          ...
          {deals.map((deal) => (
            ...
            >
              ...
              <div className="flex flex-col items-start mb-4 px-4 gap-1">
                <span className="text-black text-[18px] md:text-[20px] font-bold">Live fares</span>
                <span className="text-[#666666] text-[12px] md:text-[13px] font-normal">
                  Prices from LiteAPI after you search
                </span>
              </div>
